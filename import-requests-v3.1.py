...
# === JQL: solo attività assegnate all'utente loggato ===
...
for prio_label in ["High", "Medium", "Low", "Nessuna"]:
    ...
    # Ordina:
    # 1. Scadenze più prossime (le None vanno in fondo)
    # 2. Tra quelle senza scadenza → per data creazione più vecchia
